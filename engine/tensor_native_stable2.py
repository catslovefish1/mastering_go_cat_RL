...
class TensorBoard(torch.nn.Module):
    ...
    #       expanded = (self._count_neighbors(groups) > 0) & mask & ~groups
    #       groups = groups | expanded  # Just keep going
...
#     # If you have 3 games:
# # Game 0: 5 black stones, 3 white stones
# # Game 1: 10 black stones, 12 white stones  
# # Game 2: 7 black stones, 7 white stones
...
# black_wins = (scores[:, 0] > scores[:, 1])  # [True, False, False]
# white_wins = (scores[:, 1] > scores[:, 0])  # [False, True, False]
# draws = (scores[:, 0] == scores[:, 1])      # [False, False, True]
